...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-light-bg p-4 md:p-6 flex flex-col items-center justify-center pattern-grid-lg overflow-x-hidden">
      <MotionDiv 
      ...
      <footer className="mt-12 md:mt-24 font-bold border-3 border-dark bg-white px-6 md:px-8 py-2 md:py-3 shadow-neo rounded-full rotate-1 hover:rotate-0 transition-transform cursor-default text-dark z-10 text-sm md:text-base">
